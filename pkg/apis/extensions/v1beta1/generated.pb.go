...
func (m *ThirdPartyResource) MarshalTo(data []byte) (int, error) {
	...
	if len(m.WideDisplay) > 0 {
		for k := range m.WideDisplay {
			data[i] = 0x2a
			i++
			v := m.WideDisplay[k]
			mapSize := 1 + len(k) + sovGenerated(uint64(len(k))) + 1 + len(v) + sovGenerated(uint64(len(v)))
...
func (this *ThirdPartyResource) String() string {
	...
	keysForDisplay := make([]string, 0, len(this.Display))
	for k := range this.Display {
		keysForDisplay = append(keysForDisplay, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForDisplay)
	mapStringForDisplay := "map[string]string{"
	for _, k := range keysForDisplay {
		mapStringForDisplay += fmt.Sprintf("%v: %v,", k, this.Display[k])
	}
	mapStringForDisplay += "}"
	keysForWideDisplay := make([]string, 0, len(this.WideDisplay))
	for k := range this.WideDisplay {
		keysForWideDisplay = append(keysForWideDisplay, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForWideDisplay)
	mapStringForWideDisplay := "map[string]string{"
	for _, k := range keysForWideDisplay {
		mapStringForWideDisplay += fmt.Sprintf("%v: %v,", k, this.WideDisplay[k])
	}
	mapStringForWideDisplay += "}"
	s := strings.Join([]string{`&ThirdPartyResource{`,
		...
		`Display:` + mapStringForDisplay + `,`,
		`WideDisplay:` + mapStringForWideDisplay + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ThirdPartyResource) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			iNdEx = postStringIndexmapvalue
			if m.Display == nil {
				m.Display = make(map[string]string)
			}
			m.Display[mapkey] = mapvalue
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WideDisplay", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			mapvalue := string(data[iNdEx:postStringIndexmapvalue])
			iNdEx = postStringIndexmapvalue
			if m.WideDisplay == nil {
				m.WideDisplay = make(map[string]string)
			}
			m.WideDisplay[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipGenerated(data[iNdEx:])
...
var fileDescriptorGenerated = []byte{
	...
	,
}
