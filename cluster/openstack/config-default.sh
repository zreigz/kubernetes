...
OPENSTACK_IMAGE_NAME="Debian"

# Downloaded image name for Openstack project
IMAGE_NAME="debian-8.3.0-openstack-amd64.qcow2"

# URL for image where Kubernetes will be installed
IMAGE_URL="http://cdimage.debian.org/cdimage/openstack/current/debian-8.3.0-openstack-amd64.qcow2"
